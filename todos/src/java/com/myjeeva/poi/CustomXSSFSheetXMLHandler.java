...
/**
 * Classe copiada do framework POI, classe XSSFSheetXMLHandler, alterada para que os valores presentes nas planilhas
 * pudessem ser acessados em seu formato original, sem a formatação para exibição. Embora esses valores estejam presentes
 * no XML como strings, sua conversão direta para números (e de números para datas) permite acessar o valor independente
 * de qualquer formatação.
 * Para isso o método
 **/
public class CustomXSSFSheetXMLHandler extends DefaultHandler {
    ...
    /**
     * Método alterado de forma a produzir, além dos valores formatados para apresentação ao usuário final, os valores
     * originais sem qualquer tipo de formatação e nos tipos STRING ou NUMERICOS
     * Obs: Números podem ser, na verdade, datas, ficando a cargo do cliente da classe definir como considera-lo.
     */
    public void endElement(String uri, String localName, String name)
        ...
        if (isTextTag(name)) {
            ...
            // Modificada para armazenar também as informações: valor original e tipo do conteúdo, e formato de apresentacao do excel
    ...
    public interface SheetContentsHandler {
         ...
         * ALTERADA para passar também o valor original não formatado, o tipo (numero,string,bool) e a formatação Excel
         **/
        public void cell(String cellReference, String formattedValue, String originalValue, String format, xssfDataType nextDataType);
