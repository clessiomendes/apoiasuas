...
<body>
<a href="#list-formulario" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="descricao"
                              title="${message(code: 'formulario.descricao.label', default: 'Descricao')}"/>

            <g:sortableColumn property="codigo" title="${message(code: 'formulario.formularioPreDefinido.label', default: 'Codigo')}"/>

            <g:sortableColumn property="template"
                              title="${message(code: 'formulario.template.label', default: 'Template')}"/>
        ...
        <g:each in="${formularioInstanceList}" status="i" var="formularioInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${formularioInstance.id}">${fieldValue(bean: formularioInstance, field: "nome")}</g:link></td>

                <td>${fieldValue(bean: formularioInstance, field: "descricao")}</td>

                <td>${fieldValue(bean: formularioInstance, field: "formularioPreDefinido")}</td>
