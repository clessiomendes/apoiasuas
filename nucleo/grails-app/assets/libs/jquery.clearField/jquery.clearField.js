...
$(document).ready(function(){
	console.log('inicializando clearField')
	$('.clear-field').clearField({ clearText: 'Desfazer procura', focusAfterClear: true });
});
			...
			e.parent().append(
					jQuery(nClearLink)
						...
						.click(function() {
							...
							field.val('').trigger('input').trigger('change').trigger('keyup').trigger('keydown');
