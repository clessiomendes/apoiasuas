...
<g:render template="/personalizados/familia/detalhes/cidadao/redesSociaisCRJ" model="${[localDtoCidadao: localDtoCidadao, prefixo: prefixo]}"/>
<g:render template="/personalizados/familia/detalhes/cidadao/outrosCRJ" model="${[localDtoCidadao: localDtoCidadao, prefixo: prefixo]}"/>
