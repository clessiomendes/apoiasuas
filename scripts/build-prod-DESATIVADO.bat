...
call grails prod war --non-interactive --stacktrace -Dorg.apoiasuas.datasource=CLEVERCLOUD_POSTGRE -Dgrails.project.work.dir=tmp_deploy
...
copy .\ambientes\ambiente-%ambiente%.properties c:\workspaces\deploy-cc\%ambiente%\apoiasuas.war\WEB-INF\classes\ambiente.properties
