...
class PedidoCertidaoController extends ProcessoController {
    ...
    def listExecuta() {
        ...
        if (! erroValidacao)
            processos = pedidoCertidaoProcessoService.getProcessos(params.codigoLegado, params.dadosCertidao, idUsuarioSistema, pendentes, params.numeroAR, params.cartorio, dataInicio, dataFim)
