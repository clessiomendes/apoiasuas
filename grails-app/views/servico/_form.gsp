...
<tmpl:/layouts/sessao titulo="Descrição detalhada" icone="usecases/info-w.png">
...
<tmpl:/layouts/sessao titulo="Restrição do público atendido" icone="usecases/publico-w.png">
...
<tmpl:/layouts/sessao titulo="Documentos necessários" icone="usecases/documentos-w.png">
...
<tmpl:/layouts/sessao titulo="Endereços e horários de atendimento" icone="usecases/endereco-w.png">
...
<tmpl:/layouts/sessao titulo="Fluxo do atendimento" icone="usecases/fluxo-w.png">
...
<tmpl:/layouts/sessao titulo="Contato" icone="usecases/telefone-w.png">
    <g:campoEdicaoTexto titulo="Site na internet" name="site" quebraLinha="true" placeholder="www.meusite.com" size="60" maxlenght="255"/>
    %{--<tmpl:atualizadoEm campo="contatosInternos"/>--}%
    <g:campoEdicaoMemo titulo="Telefones de atendimento ao público" name="telefones" quebraLinha="true" placeholder=
"ex: Candidatos: (11) 2222-5555
...
%{--
<tmpl:/layouts/sessao titulo="Formulários e outros anexos" icone="usecases/anexar-w.png">
    <g:render template="formAnexos" model="${[localDtoServico: localDtoServico]}"/>
</tmpl:/layouts/sessao>
--}%

<tmpl:/layouts/sessao titulo="Encaminhamento" icone="usecases/encaminhamento-w.png">
