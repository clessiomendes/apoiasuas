/**
 * Fun��o javascript usada para submeter pesquisas de cidadaos por numero, logradouro ou nome aa partir de um link
 * passando os parametros pela url em uma requisicao GET para o servidor
 */
function linkProcurarCidadao(link, url, inputNomeOuCad, inputNumero, inputLogradouro) {
    var params = "";
